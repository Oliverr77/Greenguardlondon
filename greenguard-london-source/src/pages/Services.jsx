...
const services = [
  ...
  },
  {
    ...
    features: [
      'First application $34.99 — try risk-free',
  ...
  },
  {
    ...
    features: [
      'Spring cleanup from $199 — debris removal, bed prep, first mow',
      'Fall cleanup from $249 — leaf removal, bed winterizing, final mow',
