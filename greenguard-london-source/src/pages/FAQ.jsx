...
const faqs = [
  ...
  { q: 'What is the All-Inclusive package?', a: 'The All-Inclusive Seasonal Care package bundles mowing and fall cleanup into one discounted package. Starting from $809/season with Biweekly mowing (~13 cuts), or from $1,049/season with our Seasonal Pro mowing schedule (20 cuts, weekly May–Aug + biweekly Sep–Oct). Everything is handled for you — choose the mowing frequency that suits your lawn.' },
